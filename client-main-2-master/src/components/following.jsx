                                    ...
                                    <ListItem alignItems="flex-start" onClick={() => { navigate("/user-profile?id=" + friend._id) }}>
                                        ...
                                        <ListItemText
                                            ...
                                            secondary={<React.Fragment>
                                                ...
                                                {(user._id !== friend._id) && (user.following.includes(friend._id)) && <HowToRegIcon onClick={() => { unFollowUser(friend._id) }} color = "secondary" />}
                                                {(user._id !== friend._id) && (!user.following.includes(friend._id)) && < PersonAddAlt1Icon onClick={() => { followUser(friend._id) }} color = "secondary" />}
                                            </React.Fragment>} />
